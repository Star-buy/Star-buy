          ...
          <div class="formbg-outer">
            ...
            <div class="footer-link padding-top--24">
              <span class="span-span"
                ...
                <router-link href="" class="a-a" to="/Signup"
                  >Sign up</router-link
                ></span
              >
              <div
              ...
              >
                <span class="span-span"
                  ><a href="#" class="a-a">Contact</a></span
                >
                <span class="span-span"
                  ><a href="#" class="a-a">Privacy & terms</a></span
                >
              </div>
            </div>
          </div>
...
.field .input-input {
  ...
  border: unset;
  border-radius: 4px;
  outline-color: rgba(8, 9, 17, 0.5);
  background-color: rgb(255, 255, 255);
  box-shadow: rgba(247, 0, 0, 0) 0px 0px 0px 0px,
...
.input-input[type="submit"] {
  ...
  box-shadow: rgb(0 0 0 / 0%) 0px 0px 0px 0px, rgb(0 0 0 / 0%) 0px 0px 0px 0px,
    rgb(0 0 0 / 12%) 0px 1px 1px 0px, #131313 0px 0px 0px 1px,
    rgb(0 0 0 / 0%) 0px 0px 0px 0px, #0f69d6 0px 0px 0px 0px,
